...
24 сентября 2026 года `flutter analyze` прошёл без замечаний, APK и AAB
успешно собраны в release-режиме с тестовой подписью на Flutter 3.47.5.
[Успешная сборка и скачивание файлов](https://github.com/ROikkrl/BMray/actions/runs/35963202894)
соответствуют коммиту `24e3cb371ca21115d958b7d6faef2c986b42351d`.
